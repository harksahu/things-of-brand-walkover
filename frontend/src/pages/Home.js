        ...
        <Row className="mt-5">
          <Col xs={12} md={8} lg={6} className="mx-auto text-center">
            <h1 className="display-4 heading">
              <span className="w">W</span>here are your brand assets
              <span className="q">?</span>
            </h1>
            <p className="mt-4">
              Streamline your creative workflow with our Robust brand asset management platform              
            </p>
        ...
        <Row className="mt-5">
          <Col xs={12} lg={10} className="mx-auto text-center">
            <div className="fw-bold text-black-50">
              They manage their assets on our platform
            </div>
            ...
            <Link to="/all-companies">& more...</Link>
          </Col>
        </Row>
      </Container>
    </>
